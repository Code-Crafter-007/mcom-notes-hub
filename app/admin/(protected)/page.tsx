...
export default function AdminPanelPage() {
  ...
  const startEditPyq = async (id: number) => {
  const { data, error } = await supabase
    .from("pyqs")
    .select("*")
    .eq("id", id)
  ...
  if (data && !error) {
    ...
    alert("Failed to load PYQ for editing.");
  }
};
          ...
          <div className="note-list">
            {pyqs.map((pyq) => (
              <div key={pyq.id} className="note-card">
                ...
                <div className="note-actions">
<button onClick={() => startEditPyq(pyq.id)}>✏️ Edit</button> 
                  <button
                    onClick={() =>
      ...
      {/*********************************Modal for  notes details edititng *************************************** */}
  {editingNoteBasic && editingNoteDetails && (
    ...
    <div className="edit-modal-content">
      ...
      <form onSubmit={handleEditSave}>
        ...
        <div className="form-group">
          <label>Subject</label>
          <input
            value={editingNoteBasic.subject}
            onChange={(e) =>
              setEditingNoteBasic({
                ...editingNoteBasic,
        ...
        <div className="form-row">
          <div className="form-group">
            <label>Semester</label>
            <select
              value={editingNoteBasic.semester}
              onChange={(e) =>
                setEditingNoteBasic({
                  ...editingNoteBasic,
        ...
        <div className="form-group">
          <label>Description</label>
          <textarea
            value={editingNoteBasic.description}
            onChange={(e) =>
              setEditingNoteBasic({
                ...editingNoteBasic,
        ...
        {/* Note Details fields */}
        <h3 style={{ marginTop: "1.5rem" }}>📋 Extra Details</h3>
        <div className="form-group">
          <label>Features (comma separated)</label>
          <input
            value={editingNoteDetails.features?.join(", ") || ""}
            onChange={(e) =>
        ...
        <div className="form-group">
          <label>Topics (comma separated)</label>
          <input
            value={editingNoteDetails.topics?.join(", ") || ""}
            onChange={(e) =>
              setEditingNoteDetails({
                ...editingNoteDetails,
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input
              type="number"
              value={editingNoteDetails.pages}
              onChange={(e) =>
                setEditingNoteDetails({
                  ...editingNoteDetails,
                  pages: e.target.value,
          ...
          <div className="form-group">
            <label>Language</label>
            <input
              value={editingNoteDetails.language}
              onChange={(e) =>
                setEditingNoteDetails({
                  ...editingNoteDetails,
                  language: e.target.value,
        ...
        <div className="form-row">
          <div className="form-group">
            <label>Format</label>
            <input
              value={editingNoteDetails.format}
              onChange={(e) =>
                setEditingNoteDetails({
                  ...editingNoteDetails,
                  format: e.target.value,
          ...
          <div className="form-group">
            ...
            <input
              type="date"
              value={editingNoteDetails.last_updated?.slice(0, 10)}
              onChange={(e) =>
                setEditingNoteDetails({
                  ...editingNoteDetails,
                  last_updated: e.target.value,
      ...
      {/*********************************Modal for edititng  pyqs details edititng *************************************** */}
      ...
      >
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) =>
              setEditingPyq({ ...editingPyq, subject: e.target.value })
            }
          />
        </div>
        <div className="form-row">
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                setEditingPyq({ ...editingPyq, semester: e.target.value })
              }
            >
              {[1, 2, 3, 4].map((s) => (
                <option key={s} value={s}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                setEditingPyq({ ...editingPyq, year: e.target.value })
              }
            />
          </div>
        </div>
